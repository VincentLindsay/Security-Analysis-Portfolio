...
# Logical Diagram
<img width="1192" height="703" alt="image" src="https://github.com/user-attachments/assets/e93f5127-a4db-4247-a6a7-1446935acd30" />



* This Diagram represents the infrastructure used in this project, as well as a visual perspective of the tools and machines used in this project


## Setting up VMware
This Lab utilizes VMware workstation as our hypervisor
* I installed VirtualBox by visiting the support page on broadcom's support [page](https://support.broadcom.com/)
* I created an account, and after logging in I selected my Downloads
<img width="1915" height="358" alt="image" src="https://github.com/user-attachments/assets/d2d1d4a6-1b85-4c90-8a2c-4a5a3c1536be" />

* Under the free software downloads, I selected VMware Workstation Pro
<img width="737" height="77" alt="image" src="https://github.com/user-attachments/assets/cfbf2320-dc7c-4e12-a642-2751d2151075" />

* Since my host machine is Windows, I chose the download option for Windows
* Once installed, I began to configure the virtual machines
...
```
<img width="1712" height="662" alt="image" src="https://github.com/user-attachments/assets/d4006cf8-275a-4cd1-906c-a366f0407e8e" />
