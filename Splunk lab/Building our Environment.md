# Overview
This section involves the development of the virtual machines used in this lab, the machines used will be an Ubuntu server (ver. 24.04.3), and a Windows 10 pro VM.
